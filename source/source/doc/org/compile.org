...
#+DESCRIPTION: How to compile C++20 programs using Spot
#+INCLUDE: setup.org
...
explanations might be GNU/Linux specific, they may hint you about how
...
1. The language that we use is C++20 (or optionally C++23).  This
   usually requires passing an option like =-std=c++20=.  Note that
   with version 16 of =g++= the default will be to compile C++20, so
...
#+BEGIN_SRC sh
g++ -std=c++20 hello.cc -lspot -o hello
./hello
#+END_SRC
...
#+BEGIN_SRC sh
g++ -std=c++20 -I/usr/local/include hello.cc -L/usr/local/lib -lspot -o hello
#+END_SRC
...
#+BEGIN_SRC sh
g++ -std=c++20 -I$HOME/usr/include hello.cc -L$HOME/usr/lib -lspot -o hello
#+END_SRC
and execute with
#+BEGIN_SRC sh
...
#+BEGIN_SRC sh
/dir/spot-X.Y/libtool link g++ -std=c++20 -I/dir/spot-X.Y -I/dir/spot-X.Y/buddy/src hello.cc /dir/spot-X.Y/spot/libspot.la -o hello
#+END_SRC
