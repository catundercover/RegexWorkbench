...
- *Simplifying LTL Model Checking Given Prior Knowledge*,
  ...
  Discuss the use and implementation of =autfilt --given-formula=.

- *Engineering an LTLf Synthesis Tool*
  /Alexandre Duret-Lutz/, /Shufang Zhu/, /Nir Piterman/,
  /Giuseppe De Giacomo/, and /Moshe Y. Vardi/.
  In Proc. of CIAA'25.  LNCS 15981, pp. 129--147.  Sep. 2025.
  ([[https://www.lrde.epita.fr/~adl/dl/adl_bib.html#duret.25.ciaa][bib]] | [[https://www.lrde.epita.fr/~adl/dl/adl/duret.25.ciaa.pdf][pdf]] | [[https://www.lrde.epita.fr/~adl/dl/adl/duret.25.ciaa.slides.pdf][slides]])
...
- *Reactive Synthesis from LTL Specification with Spot*,
  ...
  In Proc. of SYNT@CAV'18.  ([[https://www.lrde.epita.fr/~max/bibtexbrowser.php?key=michaud.18.synt&bib=perso.bib][bib]] | [[https://www.lre.epita.fr/dload/papers/michaud.18.synt.pdf][pdf]])
...
- *Model checking using generalized testing automata*, /Ala Eddine Ben
  ...
  [[file:ltl2tgta.org][=ltl2tgta=]] tool, which was last distributed with Spot 2.14.x.
