# -*- coding: utf-8 -*-
#+TITLE: Code Examples
#+DESCRIPTION: Directory of code examples for using Spot in C++20, Python, and shell.
#+INCLUDE: setup.org
...
- [[file:tut60.org][Using ppLTLTT to work with pure-past LTL subformulas]]
...
- [[file:tut91.org][Working with Multi-Terminal BDDs (MTBDDs)]]
...
- [[https://spot.lrde.epita.fr/ipynb/syntunobs.html][=syntunobs.ipynb=]] illustrates support for synthesis with unobservable variables
...
- [[https://spot.lrde.epita.fr/ipynb/mtdtwa.html][=mtdtwa.ipynb=]] MTBDD-based deterministic transition-based ω-automata
  (not very developed)
- [[https://spot.lrde.epita.fr/ipynb/mtdswa.html][=mtdswa.ipynb=]] MTBDD-based deterministic transition-based
  ω-automata, with obligation translation and synthesis support


#  LocalWords:  utf html bdd IPython ipynb io randaut accparse acc
#  LocalWords:  cond randltl genltl genaut scc ltsmin dve
