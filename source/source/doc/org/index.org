...
#+KEYWORDS: Spot,C++20,library,platform,framework,tool-suite,LTL,PSL,omega-automata
#+INCLUDE: setup.org
#+HTML_HEAD_EXTRA: <style>#org-div-home-and-up { display: none; }</style>

Spot is a C++20 library for LTL, ω-automata manipulation and model
...
- Support for ω-automata with [[file:concepts.org::#acceptance-condition][arbitrary acceptance condition]] (a.k.a.
...
- The automaton parser can read a stream of automata written in any of
  five syntaxes ([[file:hoa.org][HOA]], [[http://spinroot.com/spin/Man/never.html][never claims]], [[http://www.tcs.hut.fi/Software/lbtt/doc/html/Format-for-automata.html][LBTT]], [[http://www.ltl2dstar.de/docs/ltl2dstar.html][DSTAR]], [[https://github.com/tcsprojects/pgsolver][PGsolver]]).
